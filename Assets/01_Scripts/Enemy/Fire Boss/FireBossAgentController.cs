...
public class FireBossAgentController : MonoBehaviour
{
    [SerializeField] private FireBossEntity _fireBossEntity;
    [SerializeField] private FireBossAnimator _fireBossAnimatorMono;
    [SerializeField] private FireBossAttackManager _fireBossAttackManager;
    [SerializeField] private FireBossSpellManager _fireBossSpellManager;
    [SerializeField] private NavMeshAgent _navMeshAgent;
    [SerializeField] private Transform _fireBossTransform, _playerTransform;
    ...
    {
        _speedMaxCurrent = _fireBossEntity.SpeedWalk;
    ...
    private void Update()
    {
        if (_playerTransform != null)
        {
            ...
            if (_makePauseDistance || _makePauseDestinationAttack || !_navMeshAgent.hasPath)
            {
                ...
                if (_canAttack)
                {
                    _fireBossAttackManager.SetAttack(true, 1);
                    _canAttack = false;
                }
            }
    ...
    private void Rotate()
    {
        Vector3 relativePos = _playerTransform.position - _fireBossTransform.position;
        // Annule la rotation y;
        relativePos.y = 0;
        // the second argument, upwards, defaults to Vector3.up
        Quaternion rotation = Quaternion.LookRotation(relativePos, Vector3.up);
        _fireBossTransform.rotation = rotation;
    }
    ...
    public Transform FireBossTransform { get => _fireBossTransform; set => _fireBossTransform = value; }
