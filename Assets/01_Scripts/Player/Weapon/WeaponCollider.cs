...
public class WeaponCollider : MonoBehaviour
{
    ...
    {
        if (other.gameObject.tag == "Sliceable" && _stateMachineAttack.CanSlice)
        {
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.gameObject.tag == "Sliceable" && _stateMachineAttack.CanSlice)
        {
            ...
            GameObject _parent = Instantiate(_emptyParent, other.gameObject.transform.parent);
            _parent.name = "Parent Of : " + other.gameObject.name;

            GameObject[] slices = Slicer.Slice(plane, other.gameObject, _parent.transform);
